...
export default function Edit( { attributes, setAttributes, context } ) {
	...
	const { availabilityMeta, postType } = useSelect(
		( select ) => {
			if ( ! postId ) {
				return { availabilityMeta: {}, postType: null };
			}
			...
			return {
				availabilityMeta: {
					rolling_upcoming_period:
						post?.meta?.rolling_upcoming_period || '6',
	...
	const dateRange = calculateDateRange(
		availabilityMeta.rolling_upcoming_period
	);
		...
		<>
			<InspectorControls>
				<PanelBody title={ __( 'Query Settings', 'kate-toms-core' ) }>
					...
					<TextControl
						...
						type="number"
						help={ __(
							'Number of houses to display. Use -1 to show all matching houses.',
							'kate-toms-core'
						) }
					/>
				</PanelBody>
			...
			<div { ...blockProps }>
				<div className="house-availability-landing-pages-preview">
					<h3>
						{ __(
							'House Availability Landing Pages Block',
							'kate-toms-core'
						) }
					</h3>
					...
					{ postType !== 'availability' ? (
						...
						>
							<p>
								<strong>
									{ __(
										'⚠️ This block only works on Availability post types',
										'kate-toms-core'
									) }
								</strong>
							</p>
							<p>
								{ __(
									'Please add this block to an availability post to see houses filtered by rolling availability periods.',
									'kate-toms-core'
								) }
							</p>
						</div>
						...
						<>
							...
							>
								...
								<p>
									...
									<strong>
										{ formatPeriods(
											availabilityMeta.periods_to_include
										) }
									</strong>
								</p>
							</div>
							...
							>
								<p>
									<em>
										{ __(
											'Houses will be filtered based on availability in the next ' +
												availabilityMeta.rolling_upcoming_period +
												' weeks, matching the selected periods. Preview shows configuration only - actual filtering happens on the frontend.',
											'kate-toms-core'
										) }
									</em>
								</p>
