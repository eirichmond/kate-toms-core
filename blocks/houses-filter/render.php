...
>
	...
	>
		<div class="houses-filter__grid">
			...
			<div class="houses-filter__field">
				<label class="houses-filter__label screen-reader-only" for="<?php echo esc_attr( "{$filter_id}-date" ); ?>">
					<?php esc_html_e( 'Select Date', 'kate-and-toms-houses-filter-search' ); ?>
				</label>
				<input 
					type="date" 
					id="<?php echo esc_attr( "{$filter_id}-date" ); ?>"
					class="houses-filter__date"
					data-wp-bind--value="state.date"
					data-wp-on--change="actions.updateDate"
				/>
			...
			<div class="houses-filter__field">
				...
				<div class="houses-filter__size-controls">
					<select 
						class="houses-filter__select"
						data-wp-on--change="actions.updateSize"
						data-wp-bind--value="state.activeFilters.size[0] || ''"
						data-wp-bind--aria-pressed="state.activeFilters.size.includes(value)"
					>
						<option value=""><?php esc_html_e( 'Select a size', 'kate-and-toms-houses-filter-search' ); ?></option>
			...
			<div class="houses-filter__field">
				...
				<div class="houses-filter__location-controls">
					<select 
						class="houses-filter__select"
						data-wp-on--change="actions.updateLocation"
						data-wp-bind--value="state.activeFilters.local[0] || ''"
						data-wp-bind--aria-pressed="state.activeFilters.local.includes(value)"
					>
						<option value=""><?php esc_html_e( 'Select a location', 'kate-and-toms-houses-filter-search' ); ?></option>
			...
			<div class="houses-filter__field">
				...
				<div class="houses-filter__feature-controls">
					<select 
						class="houses-filter__select"
						data-wp-on--change="actions.updateFeature"
						data-wp-bind--value="state.activeFilters.feature[0] || ''"
						data-wp-bind--aria-pressed="state.activeFilters.feature.includes(value)"
					>
						<option value=""><?php esc_html_e( 'Select a feature', 'kate-and-toms-houses-filter-search' ); ?></option>
	...
	<!-- Results Region -->
	<div 
		class="houses-filter__results" 
		data-wp-router-region="<?php echo esc_attr( $results_region ); ?>"
