...
export default function Edit({ attributes, setAttributes }) {
	...
	const availableIcons = [
		...
		{ value: 'speech-bubble', label: __('Speech Bubble', 'kate-toms-core') },
		{ value: 'magnifying-glass', label: __('Magnifying Glass', 'kate-toms-core') }
	];
	...
	return (
		<>
			...
			<InspectorControls>
				<PanelBody title={__('Icon Settings', 'kate-toms-core')} initialOpen={true}>
					<ToggleControl
					...
					{showIcon && (
						<>
							...
							{selectedIcon && (
								<>
									<RadioControl
										label={__('Icon Position', 'kate-toms-core')}
										selected={iconPosition}
										options={[
											{ label: __('Prepend (before text)', 'kate-toms-core'), value: 'prepend' },
											{ label: __('Append (after text)', 'kate-toms-core'), value: 'append' }
										]}
										onChange={(value) => setAttributes({ iconPosition: value })}
									/>

									<RangeControl
										label={__('Icon Size', 'kate-toms-core')}
										value={iconSize}
