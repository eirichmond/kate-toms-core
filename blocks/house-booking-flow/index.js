	...
	return (
		<div {...blockProps}>
			<div className="booking-flow-placeholder">
				...
				<p>{__('This block will display the booking steps based on URL parameters.', 'kate-toms-core')}</p>
				...
				<p><small>{__('The actual booking flow will be displayed on the frontend when URL parameters are present.', 'kate-toms-core')}</small></p>
			</div>
		</div>
	);
}
