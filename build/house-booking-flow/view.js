/******/ (() => { // webpackBootstrap
/*!*******************************************!*\
  !*** ./blocks/house-booking-flow/view.js ***!
  \*******************************************/
/**
...
class HouseBookingFlow {
  ...
  resetRecaptcha() {
    if (this.recaptchaWidgetId !== null && this.recaptchaWidgetId !== undefined && typeof window.grecaptcha !== 'undefined' && typeof window.grecaptcha.reset === 'function') {
      try {
  ...
  handleStep2Submission(event) {
    ...
    const siteKey = this.config.recaptchaSiteKey;
    const recaptchaContainer = this.containerEl.querySelector('.booking-recaptcha');
    const priorRecaptchaError = recaptchaContainer ? recaptchaContainer.querySelector('.recaptcha-error') : null;
    if (priorRecaptchaError) {
      priorRecaptchaError.remove();
    }
    let recaptchaToken = '';
    if (siteKey && typeof window.grecaptcha !== 'undefined' && this.recaptchaWidgetId !== null && this.recaptchaWidgetId !== undefined) {
