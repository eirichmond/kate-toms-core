...
error_log( sprintf( 'House Seasonal Landing Pages render.php executing for post ID %d, type: %s', $current_post_id, $current_post_type ) );
...
error_log( sprintf(
	'Seasonal filtering: %d houses, dates %s to %s, periods: %s',
...
error_log( sprintf( 'Seasonal filtering result: %d houses matched', count( $filtered_houses ) ) );
...
?>
<div <?php echo get_block_wrapper_attributes( array( 'class' => 'house-seasonal-landing-pages' ) ); ?>>
