...
$category = sanitize_text_field($attributes['category'] ?? 'cotswolds');
...
// Map category to pattern slugs (like houses-filtered-results does)
$pattern_slugs = [
	'coast' => 'katomswold/house-card-search-coast',
