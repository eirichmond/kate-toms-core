/******/ (() => { // webpackBootstrap
/*!************************************!*\
  !*** ./blocks/icon-button/view.js ***!
  \************************************/
/**
 * Frontend JavaScript for Icon Button block
 * Handles form triggering functionality
 */

jQuery(document).ready(function ($) {
  const buttons = $('.wp-block-kate-and-toms-icon-button[data-show-form="true"]');
  ...
  buttons.each(function () {
    $(this).on('click', function (e) {
      // Only prevent default if we're showing a form
      e.preventDefault();
